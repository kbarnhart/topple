function topple0403fxn(outPath, t, dt, iceon, water_height, wave, m, m_air, method)
...
if iceon(i)==1
    ...
    while toErode>0
        ...
        try
            [xnew,znew]=erodebluff(x,z, water_height(i), wave(i), erodeAmt,airAmt, shelf_slope, xmax, wedge);% beach_slope, beach_length);   
...
if rem (i, 20000)==0
       ...
       fprintf([ num2str(i) ' iterations of ' num2str(numel(m)) '  ' datestr(t(i)) '\n'] ) 
