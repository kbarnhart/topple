...
method='white';         % string            % method for determining melt rate as a function of environment
                                            % 'white'= white/kubat 
                                            % 'rh'= russel head 
subair_coeff=0.0005; % m/(degC day)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load matprop
...
for k=1:1%length(subMarineModel)
    ...
    %try
         topple0501fxn_observationPeriodMOVIE(outPath, t, dt, obsiceon, setUp, waveHeight, m, m_air, method);
    %catch
         fprintf('failed')
    %end
